...
For this reason, we need to establish equivalence bounds (these are similar to 
smallest effect size of interest [SESI] and regions of practical equivalence 
[ROPEs], if you are familiar with them).
